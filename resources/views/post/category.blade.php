...
@section('title', 'Posts category ' . $category->name)

@section('content')
<div class="my-5">
   <div class="container">
     <div class="page-header">
       <h1 class="page-title">{{ 'Posts category ' . $category->name  }}</h1>
     </div>
   <div class="row row-cards row-deck">
     ...
     @empty
       <div class="col-12">
         <div class="card card-body"><strong>Tidak ada post dalam kategori ini</strong></div>
       </div>
     @endforelse
