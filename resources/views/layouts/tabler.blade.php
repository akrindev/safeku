...
<link rel="manifest" href="/manifest.json">
    ...
    <meta name="application-name" content="safeku">

    <meta name="msapplication-TileImage" content="/ms-icon-144x144.png">

    <title>@yield('title') | Safeku</title>

<!-- open graph -->
<meta property="og:url" content="{{ url()->current() }}" />
<meta property="og:type" content="article" />
<meta content='Safeku' property='og:site_name'/>
        ...
        <div class="container">
          <div class="row align-items-center flex-row-reverse">
            ...
            <div class="col-12 col-lg-auto mt-3 mt-lg-0 text-center">
              Copyright © 2018 <a href="/">Safeku</a>. Theme by <a href="https://codecalm.net" target="_blank">codecalm.net</a> All rights reserved.
            </div>
